...
class MainLocators():
    ...
    VERBATIMTEXT_3D = (
        By.CSS_SELECTOR, ".content > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > p:nth-child(4)")
    VERBATIMTEXT_310533 = (
        By.CSS_SELECTOR, ".content > div:nth-child(2) > div:nth-child(1) > div:nth-child(3) > p:nth-child(3)")
    ...
    HIGHLIGHTING_COLOR = (By.CSS_SELECTOR,
                          "table.list > tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(2) > p:nth-child(1) > a:nth-child(1)")  # Выделение цветом
